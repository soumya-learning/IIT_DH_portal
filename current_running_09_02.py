...
def read_keypad_input(prompt, mode="NUMBER", display_line2="", show_as_password=False):
    ...
    mode: NUMBER, ALPHA
    show_as_password: if True, display as asterisks
...
def enroll_student():
    ...
    try:
        ...
        display_msg("ENROLLMENT", "Enter Batch Year", "Use Keypad,OK=Ctr")
        time.sleep(1)
        ...
        display_msg("ENROLLMENT", "Last 3 Digits", "Use Keypad,OK=Ctr")
        time.sleep(1)
